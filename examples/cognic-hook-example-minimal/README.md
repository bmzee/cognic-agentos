...
uv run agentos test-harness .    # hooks: PASS
...
The harness dispatches through the public `Hook.invoke()` seam. **Sign + verify
are kind-agnostic** — the lifecycle runs end-to-end through the supply-chain
and trust-gate path.
