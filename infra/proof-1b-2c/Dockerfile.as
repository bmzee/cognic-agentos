# infra/proof-1b-2c/Dockerfile.as — PROOF-ONLY emulated-external OAuth AS (M3-E2c, RS256 mode)
...
# serves JWKS so the released oracle pack's real PyJWKClient verifier can verify the token (M3-E2c). The
...
# infra/proof-1b-2c/ (NOT repo root): the runner copies _local_as.py into this context before `docker build`,
