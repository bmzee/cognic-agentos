#!/usr/bin/env bash
set -euo pipefail
NS="${NS:-cognic-proofm8}"; T="proof-m8"; ASHOST="192.88.99.9_9000"; AS="http://192.88.99.9:9000"
...
# Secret mount (see run-proof-m8.sh + agentos-sandbox-patch.yaml; vault://
...
# must equal proof-m8-values.yaml secrets.vaultToken (else `vault` 403s).
