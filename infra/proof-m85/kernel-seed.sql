...
--
-- Tenant: proof-m85 (the proof-m6 tenant convention). Idempotent: every INSERT
...
VALUES
  (gen_random_uuid(), 'proof-m85', 'analyst.amir', 'retail_analytics', now()),
  (gen_random_uuid(), 'proof-m85', 'analyst.amir', 'financials', now()),
  (gen_random_uuid(), 'proof-m85', 'analyst.sara', 'cards_analytics', now()),
  (gen_random_uuid(), 'proof-m85', 'analyst.sara', 'retail_analytics', now())
...
VALUES
  (gen_random_uuid(), 'proof-m85', 'bank-analyst', 'skill', 'customer-data', now()),
  (gen_random_uuid(), 'proof-m85', 'bank-analyst', 'skill', 'financial-data', now()),
  (gen_random_uuid(), 'proof-m85', 'bank-analyst', 'skill', 'cards-data', now()),
  (gen_random_uuid(), 'proof-m85', 'bank-analyst', 'tool', 'cognic-tool-oracle-schema/run_readonly_query', now())
