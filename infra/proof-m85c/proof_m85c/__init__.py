...
(``COPY proof_m85c/ /app/proof_m85c/`` + ``PYTHONPATH=/app``) so uvicorn can boot
``proof_m85c.proof_app:create_proof_app``. NOT kernel product code — see
:mod:`proof_m85c.proof_app`'s header for why this factory is unacceptable in
production.
"""
