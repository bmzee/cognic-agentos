...
#: ``MCPToolInvocationRefused.reason`` -> HTTP status. The 11-value enum
#: (HP-4 added tool_approval_originator_mismatch -> 403; D2 phase B added
#: tool_approval_consumed -> 409) is wire-public +
