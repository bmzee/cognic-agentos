...
def test_eval_scope_family_has_exactly_five_values() -> None:
    # Sprint 13b added eval.adversarial.run (4 → 5); advancing this drift pin is
    # the reviewed act it guards.
    expected = {
        "eval.judge.run",
        "eval.bulk.run",
        "eval.runs.read",
